  ...
  <div class="auth-panel">
    ...
    <div class="auth-panel__content">
      <h2 class="auth-panel__heading">
        Bergabung &amp;<br>mulai <span style="color:var(--blue-300)">explore</span>
      </h2>
      <p class="auth-panel__text">
        Buat akun gratis dan nikmati akses ke ribuan event seru di seluruh Indonesia.
      </p>
      <div class="auth-features">
        <?php
        $features = [
          ['icon'=>'✨', 'text'=>'Akses gratis ke semua event publik'],
          ['icon'=>'📱', 'text'=>'Tiket digital langsung di genggamanmu'],
          ['icon'=>'🎁', 'text'=>'Promo eksklusif untuk member baru'],
          ['icon'=>'⭐', 'text'=>'Wishlist dan rekomendasi event personal'],
        ];
    ...
    <div class="auth-form-wrap fade-up">
      ...
      <?php if ($success): ?>
        <div class="alert alert-success" style="margin-bottom:1.25rem">
          ...
          <a href="<?= BASE_URL ?>/login.php" style="margin-left:0.5rem;font-weight:700">Login →</a>
        </div>
      <?php endif; ?>
      ...
      <div class="auth-divider"><span class="auth-divider-text">atau daftar dengan email</span></div>
